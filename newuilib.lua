...
getgenv().themes = {
    Dark = {
        ...
        ToggleEnabled = Color3.fromRGB(68, 99, 13),
        ToggleEnabledMouseOver = Color3.fromRGB(58, 84, 10),
        ...
        SliderFill = Color3.fromRGB(68, 99, 13),
        SliderFillSliding = Color3.fromRGB(58, 84, 10),
