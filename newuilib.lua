...
local library = {flags = {}, toggled = true, keybind = Enum.KeyCode.BackSlash, dragSpeed = 0.1}
...
getgenv().themes = {
    Dark = {
        ...
        ToggleEnabled = Color3.fromRGB(82, 14, 14),
        ToggleEnabledMouseOver = Color3.fromRGB(64, 11, 11),
        ...
        SliderFill = Color3.fromRGB(82, 14, 14),
        SliderFillSliding = Color3.fromRGB(64, 11, 11),
